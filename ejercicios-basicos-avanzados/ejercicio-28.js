...
for (const tiempo of albums){
    if (tiempo.genre == 'Rock'){
        tiempoRock += tiempo.duration;
    }
}

console.log("El tiempo todal, en minutos, de los álbumes de rock es de", tiempoRock);