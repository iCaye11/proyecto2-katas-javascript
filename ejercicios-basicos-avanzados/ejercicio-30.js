...
const cancionPorGenero = {};

for (const pista of tracks){
    let genre = pista.genre;
    (cancionPorGenero[genre] = cancionPorGenero[genre] || []).push(pista.title)
}
console.log(cancionPorGenero);